...
execute if score lcg shroomhearth matches 0 run item modify entity @s armor.head endchant:punch
execute if score lcg shroomhearth matches 1 run item modify entity @s armor.head endchant:power
