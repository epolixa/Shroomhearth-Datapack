...
execute if score lcg shroomhearth matches 0 run item modify entity @s armor.head endchant:quick_charge
...
execute if score lcg shroomhearth matches 2 unless predicate endchant:enchanted/head/multishot run item modify entity @s armor.head endchant:piercing
execute if score lcg shroomhearth matches 2 if predicate endchant:enchanted/head/multishot run item modify entity @s armor.head endchant:unbreaking
