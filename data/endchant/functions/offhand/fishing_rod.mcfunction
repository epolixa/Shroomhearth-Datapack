...
execute if score lcg shroomhearth matches 0 run item modify entity @s weapon.offhand endchant:lure
execute if score lcg shroomhearth matches 1 run item modify entity @s weapon.offhand endchant:luck_of_the_sea
