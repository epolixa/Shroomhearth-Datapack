...
execute if score lcg shroomhearth matches 0 run item modify entity @s weapon.mainhand endchant:lure
execute if score lcg shroomhearth matches 1 run item modify entity @s weapon.mainhand endchant:luck_of_the_sea
