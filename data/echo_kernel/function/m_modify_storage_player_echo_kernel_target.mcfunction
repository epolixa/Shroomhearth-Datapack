...
$execute if entity @s[nbt={Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{shroomhearth_id"echo_kernel"}}}]}] run data modify storage shroomhearth:players $(key_string).echo_kernel.item set from entity @s Inventory[{Slot:-106b}]
$execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{shroomhearth_id"echo_kernel"}}}}] run data modify storage shroomhearth:players $(key_string).echo_kernel.item set from entity @s SelectedItem
