...
# announce extension
tellraw @a [{"text":"The "},{"color":"#98DAC0","translate":"community.favor.water_breathing","hover_event":{"action":"show_text","value":{"translate":"community.favor.water_breathing.tooltip"}}},{"color":"white","text":" favor was extended by "},{"selector":"@s"}]
