...
# announce activation
tellraw @a [{"text":"The "},{"color":"#c6c6c6","translate":"community.favor.keep_inventory","hover_event":{"action":"show_text","value":{"translate":"community.favor.keep_inventory.tooltip"}}},{"color":"white","text":" favor was activated by "},{"selector":"@s"}]
