...
# announce extension
tellraw @a [{"text":"The "},{"color":"#D9C043","translate":"community.favor.haste","hover_event":{"action":"show_text","value":{"translate":"community.favor.haste.tooltip"}}},{"color":"white","text":" favor was extended by "},{"selector":"@s"}]
