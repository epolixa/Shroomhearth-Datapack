...
# announce activation
tellraw @a [{"text":"The "},{"color":"#00ff00","translate":"community.favor.xp_rain","hover_event":{"action":"show_text","value":{"translate":"community.favor.xp_rain.tooltip"}}},{"color":"white","text":" favor was activated by "},{"selector":"@s"}]
