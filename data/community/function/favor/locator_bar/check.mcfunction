...
execute if predicate community:has_charm if score favLocatorBar shroomhearth matches 1.. run function community:favor/locator_bar/extend
execute if predicate community:has_charm if score favLocatorBar shroomhearth matches 0 run function community:favor/locator_bar/activate