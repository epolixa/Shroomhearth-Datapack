...
execute if predicate community:has_charm if score favRegeneration shroomhearth matches 1.. run function community:favor/regeneration/extend
execute if predicate community:has_charm if score favRegeneration shroomhearth matches 0 run function community:favor/regeneration/activate