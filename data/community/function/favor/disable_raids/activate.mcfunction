...
# announce activation
tellraw @a [{"text":"The "},{"color":"#0b6138","translate":"community.favor.disable_raids","hover_event":{"action":"show_text","value":{"translate":"community.favor.disable_raids.tooltip"}}},{"color":"white","text":" favor was activated by "},{"selector":"@s"}]
