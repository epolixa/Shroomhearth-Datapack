...
# announce extension
tellraw @a [{"text":"The "},{"color":"#406278","translate":"community.favor.disable_spawning","hover_event":{"action":"show_text","value":{"translate":"community.favor.disable_spawning.tooltip"}}},{"color":"white","text":" favor was extended by "},{"selector":"@s"}]
