...
# announce activation
tellraw @a [{"text":"The "},{"color":"#406278","translate":"community.favor.disable_spawning","hoverEvent":{"action":"show_text","contents":{"translate":"community.favor.disable_spawning.tooltip"}}},{"color":"white","text":" favor was activated by "},{"selector":"@s"}]
