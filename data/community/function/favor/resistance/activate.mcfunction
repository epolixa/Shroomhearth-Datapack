...
# announce activation
tellraw @a [{"text":"The "},{"color":"#9146F0","translate":"community.favor.resistance","hover_event":{"action":"show_text","value":{"translate":"community.favor.resistance.tooltip"}}},{"color":"white","text":" favor was activated by "},{"selector":"@s"}]
