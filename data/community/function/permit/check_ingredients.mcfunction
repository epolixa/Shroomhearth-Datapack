...
execute unless predicate community:can_create_permit run tellraw @s {"translate":"community.cannot_create_permit","hoverEvent":{"action":"show_text","contents":{"translate":"community.cannot_create_permit_tooltip"}}}
