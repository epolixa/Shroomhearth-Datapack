...
data modify entity @e[type=minecraft:item,nbt={Item:{components:{"minecraft:custom_data":{shroomhearth_id"living_island_permit"}}}},limit=1,sort=nearest] Item.components."minecraft:custom_data".targetPlayerUUID set from entity @s UUID