...
execute if predicate community:has_charm if score favHorsepower shroomhearth matches 1.. run function community:favor/horsepower/extend
execute if predicate community:has_charm if score favHorsepower shroomhearth matches 0 run function community:favor/horsepower/activate