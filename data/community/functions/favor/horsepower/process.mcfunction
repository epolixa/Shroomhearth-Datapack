...
effect give @e[predicate=speedy_paths:mount] minecraft:slow_falling 2 1

# apply levitation if horse is looking up
execute as @e[predicate=speedy_paths:mount] store result score @s rotPitch run data get entity @s Rotation[1]
