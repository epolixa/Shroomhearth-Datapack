...
execute if predicate community:has_charm if score favInsomnia shroomhearth matches 1.. run function community:favor/insomnia/extend
execute if predicate community:has_charm if score favInsomnia shroomhearth matches 0 run function community:favor/insomnia/activate