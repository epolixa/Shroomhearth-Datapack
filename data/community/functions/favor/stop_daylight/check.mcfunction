...
execute if predicate community:has_charm if score favStopDaylight shroomhearth matches 1.. run function community:favor/stop_daylight/extend
execute if predicate community:has_charm if score favStopDaylight shroomhearth matches 0 run function community:favor/stop_daylight/activate