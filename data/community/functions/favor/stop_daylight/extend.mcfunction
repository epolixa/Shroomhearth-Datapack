...
bossbar set community:favor/stop_daylight name [{"color":"#c6c6c6","translate":"community.favor.stop_daylight"},{"color":"white","text":" - "},{"selector": "@s"}]

# announce extension
tellraw @a [{"text":"The "},{"color":"#c6c6c6","translate":"community.favor.stop_daylight","hoverEvent":{"action":"show_text","contents":{"translate":"community.favor.stop_daylight.tooltip"}}},{"color":"white","text":" favor was extended by "},{"selector":"@s"}]
