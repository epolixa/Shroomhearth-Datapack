...
execute if predicate community:has_charm if score favUptick shroomhearth matches 1.. run function community:favor/uptick/extend
execute if predicate community:has_charm if score favUptick shroomhearth matches 0 run function community:favor/uptick/activate