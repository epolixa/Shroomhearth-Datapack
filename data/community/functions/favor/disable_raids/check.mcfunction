...
execute if predicate community:has_charm if score favDisableRaids shroomhearth matches 1.. run function community:favor/disable_raids/extend
execute if predicate community:has_charm if score favDisableRaids shroomhearth matches 0 run function community:favor/disable_raids/activate