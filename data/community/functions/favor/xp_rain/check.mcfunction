...
execute if predicate community:has_charm if score favXPRain shroomhearth matches 1.. run function community:favor/xp_rain/extend
execute if predicate community:has_charm if score favXPRain shroomhearth matches 0 run function community:favor/xp_rain/activate