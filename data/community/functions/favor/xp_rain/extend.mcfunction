...
bossbar set community:favor/xp_rain name [{"color":"#007900","translate":"community.favor.xp_rain"},{"color":"white","text":" - "},{"selector": "@s"}]

# announce extension
tellraw @a [{"text":"The "},{"color":"#007900","translate":"community.favor.xp_rain","hoverEvent":{"action":"show_text","contents":{"translate":"community.favor.xp_rain.tooltip"}}},{"color":"white","text":" favor was extended by "},{"selector":"@s"}]
