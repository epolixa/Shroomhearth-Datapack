...
execute as @a[predicate=porcelain:in_porcelain] at @s run summon minecraft:chicken ~ 320 ~ {Tags:["xp_rain","xp_rain_falling","xp_rain_reposition"],Passengers:[{id:"minecraft:experience_orb",Tags:["xp_rain"],Value:1}],ActiveEffects:[{Id:14,ShowParticles:false,Duration:999999}],DeathLootTable:"minecraft:empty",Invulnerable:true,Silent:true}
