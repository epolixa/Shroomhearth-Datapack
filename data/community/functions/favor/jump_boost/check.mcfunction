...
execute if predicate community:has_charm if score favJumpBoost shroomhearth matches 1.. run function community:favor/jump_boost/extend
execute if predicate community:has_charm if score favJumpBoost shroomhearth matches 0 run function community:favor/jump_boost/activate