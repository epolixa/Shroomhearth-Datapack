...
# add value
scoreboard players add favClearWeather shroomhearth 2400
...
bossbar set community:favor/clear_weather max 2400
bossbar set community:favor/clear_weather style progress
bossbar set community:favor/clear_weather value 2400
