...
execute if predicate community:has_charm if score favNightVision shroomhearth matches 1.. run function community:favor/night_vision/extend
execute if predicate community:has_charm if score favNightVision shroomhearth matches 0 run function community:favor/night_vision/activate