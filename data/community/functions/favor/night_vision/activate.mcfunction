...
# announce activation
tellraw @a [{"text":"The "},{"color":"#1F1FA1","translate":"community.favor.night_vision","hoverEvent":{"action":"show_text","contents":{"translate":"community.favor.night_vision.tooltip"}}},{"color":"white","text":" favor was activated by "},{"selector":"@s"}]
