...
execute if predicate community:has_charm if score favDisableSpawning shroomhearth matches 1.. run function community:favor/disable_spawning/extend
execute if predicate community:has_charm if score favDisableSpawning shroomhearth matches 0 run function community:favor/disable_spawning/activate