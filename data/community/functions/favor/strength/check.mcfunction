...
execute if predicate community:has_charm if score favStrength shroomhearth matches 1.. run function community:favor/strength/extend
execute if predicate community:has_charm if score favStrength shroomhearth matches 0 run function community:favor/strength/activate