...
data modify entity @e[type=minecraft:item,limit=1,sort=nearest,nbt={Item:{components:{"minecraft:custom_data":{spore:"head_slot_target"}}}}] Item set from entity @s equipment.head
