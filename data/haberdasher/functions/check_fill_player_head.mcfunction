...
execute unless predicate haberdasher:can_fill_head run tellraw @s {"translate":"haberdasher.cannot_fill_head","hoverEvent":{"action":"show_text","contents":{"translate":"haberdasher.cannot_fill_head.tooltip"}}}
