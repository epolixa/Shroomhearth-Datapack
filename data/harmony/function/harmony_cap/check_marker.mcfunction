...
execute if score @s harmony_cluster < @p[tag=spawning_harmony_cap] player_group if block ~ ~-0.0625 ~ #harmony:harmony_cap_grows_on unless entity @e[tag=harmony_cap_interaction,distance=..1] run \
