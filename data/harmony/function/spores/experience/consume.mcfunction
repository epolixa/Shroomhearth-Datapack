...
tellraw @a[tag=debug_harmony] [{"text":"[harmony:spores/experience/consume] "},{"translate":"harmony.spores.experience"},{"text":" consumed by "},{"selector":"@s"}]
...
advancement revoke @s only harmony:consume_spores/experience
