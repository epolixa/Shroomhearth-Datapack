...
execute if score spores_of_health shroomhearth matches 1.. run function harmony:spores/health/extend
execute unless score spores_of_health shroomhearth matches 1.. run function harmony:spores/health/activate
