...
tellraw @a[tag=debug_harmony] [{"text":"[harmony:spores/armor/remove] removing spores.armor attribute modifier from "},{"selector":"@s"}]

# Remove Spores of Armor attribute modifier
attribute @s minecraft:armor modifier remove shroomhearth:spores.armor
