...
execute if score spores_of_armor shroomhearth matches 1.. run function harmony:spores/armor/extend
execute unless score spores_of_armor shroomhearth matches 1.. run function harmony:spores/armor/activate
