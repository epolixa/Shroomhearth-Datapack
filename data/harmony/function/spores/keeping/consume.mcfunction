...
execute if score spores_of_keeping shroomhearth.harmony matches 1.. run function harmony:spores/keeping/extend
execute unless score spores_of_keeping shroomhearth.harmony matches 1.. run function harmony:spores/keeping/activate
