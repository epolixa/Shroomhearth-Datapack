...
execute if score spores_of_leaping shroomhearth matches 1.. run function harmony:spores/leaping/extend
execute unless score spores_of_leaping shroomhearth matches 1.. run function harmony:spores/leaping/activate
