...
scoreboard players remove spores_of_leaping shroomhearth 1

# Update boss bar for Spores of Leaping duration
execute store result bossbar shroomhearth:spores_of_leaping value run scoreboard players get spores_of_leaping shroomhearth
...
execute if score spores_of_leaping shroomhearth matches ..0 run function harmony:spores/leaping/deactivate
