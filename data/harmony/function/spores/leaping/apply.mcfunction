...
attribute @s minecraft:safe_fall_distance modifier add shroomhearth:spores.leaping.safe_fall_distance 1 add_value
attribute @s minecraft:jump_strength modifier add shroomhearth:spores.leaping.jump_strength 0.1 add_value
