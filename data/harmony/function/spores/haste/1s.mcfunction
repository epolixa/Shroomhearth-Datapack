...
scoreboard players remove spores_of_haste shroomhearth 1

# Update boss bar for Spores of Haste duration
execute store result bossbar shroomhearth:spores_of_haste value run scoreboard players get spores_of_haste shroomhearth
...
execute if score spores_of_haste shroomhearth matches ..0 run function harmony:spores/haste/deactivate
