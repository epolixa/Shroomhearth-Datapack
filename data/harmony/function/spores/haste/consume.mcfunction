...
execute if score spores_of_haste shroomhearth matches 1.. run function harmony:spores/haste/extend
execute unless score spores_of_haste shroomhearth matches 1.. run function harmony:spores/haste/activate
