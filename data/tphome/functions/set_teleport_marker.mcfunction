...
execute if data storage tphome:temp player{return_dim: "minecraft:overworld"} in minecraft:overworld positioned as @s run forceload add ~ ~
execute if data storage tphome:temp player{return_dim: "minecraft:the_nether"} in minecraft:the_nether positioned as @s run forceload add ~ ~

# teleport the marker to the home dimension
execute if data storage tphome:temp player{return_dim: "minecraft:overworld"} in minecraft:overworld positioned as @s run tp @s ~ ~ ~
execute if data storage tphome:temp player{return_dim: "minecraft:the_nether"} in minecraft:the_nether positioned as @s run tp @s ~ ~ ~
