...
execute if score lcg bityard matches ..1 if score @s farmPotato matches 2.. at @e[type=item,nbt={Age:0s,Item:{id:"minecraft:potato"}},distance=..6,limit=1,sort=nearest] run summon minecraft:experience_orb ~ ~ ~ {Value:1}
