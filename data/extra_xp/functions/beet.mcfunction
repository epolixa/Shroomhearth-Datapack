...
execute if score lcg bityard matches 0 if score @s farmBeet matches 1.. at @e[type=item,nbt={Age:0s,Item:{id:"minecraft:beetroot"}},distance=..6,limit=1,sort=nearest] run summon minecraft:experience_orb ~ ~ ~ {Value:1}
execute if score lcg bityard matches 1 if score @s farmBeet matches 1.. at @e[type=item,nbt={Age:0s,Item:{id:"minecraft:beetroot"}},distance=..6,limit=1,sort=nearest] run summon minecraft:experience_orb ~ ~ ~ {Value:2}
