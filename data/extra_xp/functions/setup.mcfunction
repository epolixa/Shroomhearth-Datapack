...
scoreboard objectives remove farmBeet
scoreboard objectives add farmBeet minecraft.mined:minecraft.beetroots

scoreboard objectives remove farmCarrot
scoreboard objectives add farmCarrot minecraft.mined:minecraft.carrots

scoreboard objectives remove farmPotato
scoreboard objectives add farmPotato minecraft.mined:minecraft.potatoes
