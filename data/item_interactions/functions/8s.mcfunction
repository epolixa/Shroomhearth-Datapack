...
tag @e[type=minecraft:item,nbt={Item:{id:"minecraft:cooked_beef"}}] add persistant
tag @e[type=minecraft:item,nbt={Item:{id:"minecraft:phantom_membrane"}}] add persistant
