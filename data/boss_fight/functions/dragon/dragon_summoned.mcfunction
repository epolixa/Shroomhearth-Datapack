...
execute positioned 0 64 0 run scoreboard players set @a[distance=..190] dragonDeaths 0
...
execute positioned 0 64 0 as @a[distance=..190] at @s run summon minecraft:armor_stand ~ ~ ~ {Tags:["summon_marker"],Marker:1b,Invulnerable:1b,Invisible:1b}
execute positioned 0 64 0 as @r[distance=..190] at @s run summon minecraft:armor_stand ~ ~ ~ {Tags:["summon_marker"],Marker:1b,Invulnerable:1b,Invisible:1b}
