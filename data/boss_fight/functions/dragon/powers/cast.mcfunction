...
execute as @s[scores={bossHealth=2..60}] if score lcg shroomhearth matches 0 run function boss_fight:dragon/powers/summon
execute as @s[scores={bossHealth=61..180}] if score lcg shroomhearth matches 0..1 run function boss_fight:dragon/powers/summon
execute as @s[scores={bossHealth=181..199}] if score lcg shroomhearth matches 0..2 run function boss_fight:dragon/powers/summon

# apply effects - more common at medium health
execute as @s[scores={bossHealth=2..60}] if score lcg shroomhearth matches 1 run function boss_fight:dragon/powers/distort
execute as @s[scores={bossHealth=61..180}] if score lcg shroomhearth matches 2..3 run function boss_fight:dragon/powers/distort
execute as @s[scores={bossHealth=181..199}] if score lcg shroomhearth matches 3 run function boss_fight:dragon/powers/distort
