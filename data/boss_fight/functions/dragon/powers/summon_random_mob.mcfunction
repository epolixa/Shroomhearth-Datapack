# set lcg
scoreboard players set lcgModulus bityard 28
...
execute if score lcg bityard matches 15 run summon minecraft:ravager ~ ~ ~
execute if score lcg bityard matches 16 run summon minecraft:phantom ~ ~8 ~
execute if score lcg bityard matches 17 run summon minecraft:guardian ~ ~ ~
execute if score lcg bityard matches 18 run summon minecraft:hoglin ~ ~ ~
execute if score lcg bityard matches 19 run summon minecraft:zoglin ~ ~ ~
execute if score lcg bityard matches 20 run summon minecraft:piglin ~ ~ ~
execute if score lcg bityard matches 21 run summon minecraft:zombified_piglin ~ ~ ~
execute if score lcg bityard matches 22 run summon minecraft:piglin_brute ~ ~ ~
execute if score lcg bityard matches 23 run summon minecraft:magma_cube ~ ~ ~
execute if score lcg bityard matches 24 run summon minecraft:blaze ~ ~ ~
execute if score lcg bityard matches 25 run summon minecraft:ghast ~ ~8 ~
execute if score lcg bityard matches 26 run summon minecraft:endermite ~ ~ ~
execute if score lcg bityard matches 27 run summon minecraft:shulker ~ ~ ~
