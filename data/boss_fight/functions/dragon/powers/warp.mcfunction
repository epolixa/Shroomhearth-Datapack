# spread players
execute positioned 0 64 0 run spreadplayers 0 0 10 100 false @a[distance=..200]
...
execute at @a[distance=..200] run particle minecraft:portal ~ ~0.9 ~ 0.2 0.45 0.2 0.01 20
