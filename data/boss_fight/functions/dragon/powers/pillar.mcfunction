...
execute as @e[type=minecraft:armor_stand,tag=summon_marker] positioned 0 60 0 as @e[type=minecraft:enderman,limit=1,sort=random,distance=8..50] at @s run function boss_fight:dragon/powers/build_pillar
