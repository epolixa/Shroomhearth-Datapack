...
# show actionbar
title @a[predicate=boss_fight:on_main_end_island] actionbar {"color":"dark_purple","font":"minecraft:illageralt","bold":true,"text":"STRIKE"}
...
effect give @a[predicate=boss_fight:on_main_end_island] minecraft:night_vision 1
