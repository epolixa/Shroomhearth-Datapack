...
# show actionbar
execute positioned 0 64 0 run title @a[distance=..190] actionbar {"color":"dark_purple","font":"minecraft:alt","bold":true,"text":"STRIKE"}
...
execute positioned 0 64 0 run effect give @a[distance=..190] minecraft:night_vision 1
