...
execute as @s[scores={bossHealth=1..40}] if score bityard lcg matches 0 run function boss_fight:dragon_summon_mobs
...
execute as @s[scores={bossHealth=1..40}] if score bityard lcg matches 1 run function boss_fight:dragon_apply_effects
...
execute as @s[scores={bossHealth=1..40}] if score bityard lcg matches 2..4 run function boss_fight:dragon_restore_crystal
