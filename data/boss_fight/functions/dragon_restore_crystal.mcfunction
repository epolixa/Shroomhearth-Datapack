...
execute as @e[type=minecraft:end_crystal,tag=new_summon] at @s run summon minecraft:shulker ~ ~-1 ~ {Tags:["highlighter"],NoAI:1b,Silent:1b,DeathTime:19,DeathLootTable:"minecraft:empty"}
