...
execute if score bityard lcg matches 0 run item entity @s weapon.mainhand modify boss_fight:endchant/punch
execute if score bityard lcg matches 1 run item entity @s weapon.mainhand modify boss_fight:endchant/power
...
# show actionbar
title @s actionbar {"color":"white","text":"Your Bow attunes to the Ender Dragon"}
