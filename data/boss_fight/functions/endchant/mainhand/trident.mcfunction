...
execute if score bityard lcg matches 0 run item entity @s weapon.mainhand modify boss_fight:endchant/loyalty
execute if score bityard lcg matches 1 run item entity @s weapon.mainhand modify boss_fight:endchant/riptide
execute if score bityard lcg matches 2 run item entity @s weapon.mainhand modify boss_fight:endchant/impaling
