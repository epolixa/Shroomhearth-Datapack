...
execute if score bityard lcg matches 2 if predicate boss_fight:enchanted/mainhand/projectile_protection run item entity @s weapon.mainhand modify boss_fight:endchant/projectile_protection
execute if score bityard lcg matches 2 if predicate boss_fight:enchanted/mainhand/fire_protection run item entity @s weapon.mainhand modify boss_fight:endchant/fire_protection
execute if score bityard lcg matches 2 if predicate boss_fight:enchanted/mainhand/blast_protection run item entity @s weapon.mainhand modify boss_fight:endchant/blast_protection
...
execute if score bityard lcg matches 3 if predicate boss_fight:enchanted/mainhand/protection run item entity @s weapon.mainhand modify boss_fight:endchant/protection
...
execute if score bityard lcg matches 4 if predicate boss_fight:enchanted/mainhand/projectile_protection run item entity @s weapon.mainhand modify boss_fight:endchant/projectile_protection
...
execute if score bityard lcg matches 5 if predicate boss_fight:enchanted/mainhand/fire_protection run item entity @s weapon.mainhand modify boss_fight:endchant/fire_protection
