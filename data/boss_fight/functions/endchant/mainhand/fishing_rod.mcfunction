...
execute if score bityard lcg matches 0 run item entity @s weapon.mainhand modify boss_fight:endchant/lure
execute if score bityard lcg matches 1 run item entity @s weapon.mainhand modify boss_fight:endchant/luck_of_the_sea
...
# show actionbar
title @s actionbar {"color":"white","text":"Your Fishing Rod attunes to the Ender Dragon"}
