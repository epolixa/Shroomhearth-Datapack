...
execute if score lcg bityard matches 0 run item modify entity @s weapon.mainhand boss_fight:endchant/respiration
execute if score lcg bityard matches 1 run item modify entity @s weapon.mainhand boss_fight:endchant/thorns
...
execute if score lcg bityard matches 3 if predicate boss_fight:enchanted/mainhand/projectile_protection run item modify entity @s weapon.mainhand boss_fight:endchant/projectile_protection
...
execute if score lcg bityard matches 4 if predicate boss_fight:enchanted/mainhand/fire_protection run item modify entity @s weapon.mainhand boss_fight:endchant/fire_protection
...
execute if score lcg bityard matches 5 if predicate boss_fight:enchanted/mainhand/blast_protection run item modify entity @s weapon.mainhand boss_fight:endchant/blast_protection
...
execute if score lcg bityard matches 6 if predicate boss_fight:enchanted/mainhand/protection run item modify entity @s weapon.mainhand boss_fight:endchant/protection
