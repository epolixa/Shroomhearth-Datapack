...
execute if score lcg shroomhearth matches 0 run item modify entity @s weapon.offhand boss_fight:endchant/respiration
execute if score lcg shroomhearth matches 1 run item modify entity @s weapon.offhand boss_fight:endchant/thorns
execute if score lcg shroomhearth matches 2 run item modify entity @s weapon.offhand boss_fight:endchant/unbreaking
...
execute if score lcg shroomhearth matches 3 if predicate boss_fight:enchanted/offhand/projectile_protection run item modify entity @s weapon.offhand boss_fight:endchant/projectile_protection
...
execute if score lcg shroomhearth matches 4 if predicate boss_fight:enchanted/offhand/fire_protection run item modify entity @s weapon.offhand boss_fight:endchant/fire_protection
...
execute if score lcg shroomhearth matches 5 if predicate boss_fight:enchanted/offhand/blast_protection run item modify entity @s weapon.offhand boss_fight:endchant/blast_protection
...
execute if score lcg shroomhearth matches 6 if predicate boss_fight:enchanted/offhand/protection run item modify entity @s weapon.offhand boss_fight:endchant/protection
