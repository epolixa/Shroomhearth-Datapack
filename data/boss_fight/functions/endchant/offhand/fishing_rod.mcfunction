...
execute if score bityard lcg matches 0 run item entity @s weapon.offhand modify boss_fight:endchant/lure
execute if score bityard lcg matches 1 run item entity @s weapon.offhand modify boss_fight:endchant/luck_of_the_sea
