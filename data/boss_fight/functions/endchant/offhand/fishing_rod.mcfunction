...
execute if score lcg bityard matches 0 run item modify entity @s weapon.offhand boss_fight:endchant/lure
execute if score lcg bityard matches 1 run item modify entity @s weapon.offhand boss_fight:endchant/luck_of_the_sea
