...
execute if score bityard lcg matches 0 run item modify entity @s weapon.offhand boss_fight:endchant/quick_charge
...
execute if score bityard lcg matches 2 unless predicate boss_fight:enchanted/offhand/multishot run item modify entity @s weapon.offhand boss_fight:endchant/piercing
execute if score bityard lcg matches 2 if predicate boss_fight:enchanted/offhand/multishot run item modify entity @s weapon.offhand boss_fight:endchant/unbreaking
