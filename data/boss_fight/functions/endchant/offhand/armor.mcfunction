...
execute if score bityard lcg matches 2 if predicate boss_fight:enchanted/offhand/projectile_protection run item entity @s weapon.offhand modify boss_fight:endchant/projectile_protection
execute if score bityard lcg matches 2 if predicate boss_fight:enchanted/offhand/fire_protection run item entity @s weapon.offhand modify boss_fight:endchant/fire_protection
execute if score bityard lcg matches 2 if predicate boss_fight:enchanted/offhand/blast_protection run item entity @s weapon.offhand modify boss_fight:endchant/blast_protection
...
execute if score bityard lcg matches 3 if predicate boss_fight:enchanted/offhand/protection run item entity @s weapon.offhand modify boss_fight:endchant/protection
...
execute if score bityard lcg matches 4 if predicate boss_fight:enchanted/offhand/projectile_protection run item entity @s weapon.offhand modify boss_fight:endchant/projectile_protection
...
execute if score bityard lcg matches 5 if predicate boss_fight:enchanted/offhand/fire_protection run item entity @s weapon.offhand modify boss_fight:endchant/fire_protection
