...
execute in the_end positioned 0 64 0 as @p[distance=..200] unless entity @e[type=ender_dragon] if score bityard dragonSlain matches 0 run function boss_fight:dragon/player_kill
