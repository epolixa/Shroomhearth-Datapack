...
execute as @e[tag=voxelSocks] at @s run function voxel_socks:platforms
...
execute as @e[type=horse,nbt={SaddleItem:{relic:"pegasus_cuirass"}}] run function pegasus_cuirass:main
