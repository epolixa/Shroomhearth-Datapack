...
execute as @a[scores={playerSneak=1, frogRompersSneak=20}] at @s run playsound minecraft:entity.puffer_fish.blow_out player epolixa ~ ~ ~ 1 1
execute as @a[scores={playerSneak=1, frogRompersSneak=40}] at @s run playsound minecraft:entity.puffer_fish.blow_out player epolixa ~ ~ ~ 1 1.2
execute as @a[scores={playerSneak=1, frogRompersSneak=60}] at @s run playsound minecraft:entity.puffer_fish.blow_out player epolixa ~ ~ ~ 1 1.4

# jumpy particles
execute as @a[scores={frogRompersSneak=20..80, motionY=1..}] at @s run particle minecraft:happy_villager ~ ~0.5 ~ 0.2 0.2 0.2 0 1

# jump sound effect
execute as @a[scores={playerJump=1.., frogRompersSneak=20..39}] at @s run playsound minecraft:entity.puffer_fish.blow_up player epolixa ~ ~ ~ 1 1
execute as @a[scores={playerJump=1.., frogRompersSneak=40..59}] at @s run playsound minecraft:entity.puffer_fish.blow_up player epolixa ~ ~ ~ 1 1.2
