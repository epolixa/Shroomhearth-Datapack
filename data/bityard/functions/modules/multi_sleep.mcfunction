...
execute as @a[nbt={Sleeping:1b}, scores={playerSleep=1}] run tellraw @a [{"selector":"@s"},{"text":" fell asleep"}]
execute as @a[nbt={Sleeping:0b}, scores={playerSleep=1..}] run tellraw @a [{"selector":"@s"},{"text":" woke up"}]
