...
execute as @a[scores={reusablePearl=1..,usedPearl=1..}] at @s run summon minecraft:item ~ ~0.9 ~ {Item:{Count:1b, id:"minecraft:ender_pearl", tag:{relic: "reusable_ender_pearl", ench:[{id:-1}], display:{Name: "{\"text\":\"Re-usable Ender Pearl\"}", Lore: ["When thrown:"," +1 Re-usable Ender Pearl"]}}}}
