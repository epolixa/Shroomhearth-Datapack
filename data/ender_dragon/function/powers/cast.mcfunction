...
execute if score random shroomhearth matches 5 run function ender_dragon:powers/strike/start_sequence
...
execute if score random shroomhearth matches 6 run function ender_dragon:powers/gravity/start_sequence
