...
# speed 2 10s
execute if score random shroomhearth matches 0 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["dragon_distortion"],potion_contents:{custom_effects:[{id:"minecraft:speed",duration:200,amplifier:1}]},Duration:600,DurationOnUse:0,Radius:3.0f,RadiusOnUse:0,RadiusPerTick:0.006666667f,ReapplicationDelay:20,WaitTime:10}
# slowness 2 10s
execute if score random shroomhearth matches 1 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["dragon_distortion"],potion_contents:{custom_effects:[{id:"minecraft:slowness",duration:200,amplifier:1}]},Duration:600,DurationOnUse:0,Radius:3.0f,RadiusOnUse:0,RadiusPerTick:0.006666667f,ReapplicationDelay:20,WaitTime:10}
# haste 2 10s
execute if score random shroomhearth matches 2 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["dragon_distortion"],potion_contents:{custom_effects:[{id:"minecraft:haste",duration:200,amplifier:1}]},Duration:600,DurationOnUse:0,Radius:3.0f,RadiusOnUse:0,RadiusPerTick:0.006666667f,ReapplicationDelay:20,WaitTime:10}
# mining fatigue 10s
...
# strength 2 10s
execute if score random shroomhearth matches 4 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["dragon_distortion"],potion_contents:{custom_effects:[{id:"minecraft:strength",duration:200,amplifier:1}]},Duration:600,DurationOnUse:0,Radius:3.0f,RadiusOnUse:0,RadiusPerTick:0.006666667f,ReapplicationDelay:20,WaitTime:10}
# jump boost 2 10s
execute if score random shroomhearth matches 5 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["dragon_distortion"],potion_contents:{custom_effects:[{id:"minecraft:jump_boost",duration:200,amplifier:1}]},Duration:600,DurationOnUse:0,Radius:3.0f,RadiusOnUse:0,RadiusPerTick:0.006666667f,ReapplicationDelay:20,WaitTime:10}
# nausea 10s
...
# regeneration 2 10s
execute if score random shroomhearth matches 7 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["dragon_distortion"],potion_contents:{custom_effects:[{id:"minecraft:regeneration",duration:200,amplifier:1}]},Duration:600,DurationOnUse:0,Radius:3.0f,RadiusOnUse:0,RadiusPerTick:0.006666667f,ReapplicationDelay:20,WaitTime:10}
# resistance 2 10s
execute if score random shroomhearth matches 8 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["dragon_distortion"],potion_contents:{custom_effects:[{id:"minecraft:resistance",duration:200,amplifier:1}]},Duration:600,DurationOnUse:0,Radius:3.0f,RadiusOnUse:0,RadiusPerTick:0.006666667f,ReapplicationDelay:20,WaitTime:10}
# fire resistance 10s
...
# hunger 2 10s
execute if score random shroomhearth matches 13 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["dragon_distortion"],potion_contents:{custom_effects:[{id:"minecraft:hunger",duration:200,amplifier:1}]},Duration:600,DurationOnUse:0,Radius:3.0f,RadiusOnUse:0,RadiusPerTick:0.006666667f,ReapplicationDelay:20,WaitTime:10}
# weakness 2 10s
execute if score random shroomhearth matches 14 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["dragon_distortion"],potion_contents:{custom_effects:[{id:"minecraft:weakness",duration:200,amplifier:1}]},Duration:600,DurationOnUse:0,Radius:3.0f,RadiusOnUse:0,RadiusPerTick:0.006666667f,ReapplicationDelay:20,WaitTime:10}
# poison 10s
