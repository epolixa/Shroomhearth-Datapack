...
execute as @n[tag=!initialized,type=minecraft:item,nbt={Item:{components:{"minecraft:custom_data":{spore:"ominous_rune"}}}}] run function ender_dragon:initialize_carve_drop_with_context
