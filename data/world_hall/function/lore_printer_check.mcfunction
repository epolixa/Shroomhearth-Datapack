...
execute unless predicate world_hall:can_print_lore run tellraw @s {"translate":"world_hall.cannot_print_lore","hover_event":{"action":"show_text","value":{"translate":"world_hall.cannot_print_lore.tooltip"}}}
