...
execute unless score @s hasWhistleMaterial matches 1.. run tellraw @s {"translate":"recall.cannot_procure_whistle","hoverEvent":{"action":"show_text","contents":{"translate":"recall.cannot_procure_whistle_tooltip"}}}
