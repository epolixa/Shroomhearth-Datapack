...
execute store result score @s repairable run clear @s #recall:recall_whistle[custom_model_data=2] 0

# replace with new item
clear @s[scores={repairable=1..}] #recall:recall_whistle[custom_model_data=2] 1
