...
# Shed an Echo Shard from the nearest Warden if not on cooldown
execute as @n[type=minecraft:warden] at @s unless score @s shed_cooldown matches 1.. run function shroomhearth:warden/shed_echo_shard
