...
execute store result score @s repairable run clear @s minecraft:warped_fungus_on_a_stick[custom_data={"spore":"recall_whistle"}] 0

# replace with new item
clear @s[scores={repairable=1..}] minecraft:warped_fungus_on_a_stick[custom_data={"spore":"recall_whistle"}] 1
