...
tellraw @a[tag=debug_echo_horn] [{"text":"[shroomhearth:echo_horn/teleport_success] "},{"selector":"@s"},{"text":" successfully teleported with Echo Horn"}]
...
execute if entity @s[gamemode=!creative] run function shroomhearth:echo_horn/damage_echo_horn