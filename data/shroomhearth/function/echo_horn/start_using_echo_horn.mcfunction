...
tellraw @a[tag=debug_echo_horn] [{"text":"[shroomhearth:echo_horn/start_using_echo_horn] "},{"selector":"@s"},{"text":" started using Echo Horn"}]
...
execute if predicate shroomhearth:echo_horn/holding_blank_echo_horn_mainhand run item modify entity @s weapon.mainhand shroomhearth:echo_horn/set_timbre
execute if predicate shroomhearth:echo_horn/holding_blank_echo_horn_offhand unless predicate shroomhearth:echo_horn/holding_blank_echo_horn_mainhand run item modify entity @s weapon.offhand shroomhearth:echo_horn/set_timbre
...
execute as @s[tag=using_echo_horn_mainhand] run function shroomhearth:echo_horn/capture_echo_horn_uuid_mainhand
execute as @s[tag=using_echo_horn_offhand] run function shroomhearth:echo_horn/capture_echo_horn_uuid_offhand
...
execute as @s[tag=has_respawn_data] run function shroomhearth:echo_horn/modify_storage_player_echo_horn
