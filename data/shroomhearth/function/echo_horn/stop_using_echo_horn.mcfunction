...
# Remove forceload marker
execute as @s[tag=using_own_echo_horn,tag=has_respawn_data] run function shroomhearth:echo_horn/remove_echo_horn_forceload_marker
