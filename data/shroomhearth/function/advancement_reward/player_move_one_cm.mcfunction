...
tellraw @a[tag=debug_shroomhearth] [{"text":"[shroomhearth:advancement_reward/player_move_one_cm] "},{"selector":"@s"},{"text":" moved"}]
...
# Revoke advancement
advancement revoke @s only shroomhearth:player_move_one_cm