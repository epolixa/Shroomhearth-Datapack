...
tellraw @a[tag=debug_echoes] [{"text":"[shroomhearth:echoes/player_interacted_with_echoes] "},{"selector":"@s"},{"text":" interacted with Echoes of "},{"nbt":"data.player.name","entity":"@n[tag=echoes_interaction]"}]

# Revoke advancement
advancement revoke @s only shroomhearth:echoes/player_interacted_with_echoes
...
execute as @n[tag=echoes_interacted] at @s run function shroomhearth:echoes/m_check_visitor with storage shroomhearth:player_name
...
# Grant advancement
advancement grant @s only shroomhearth:echoes/the_long_dream