# Executor: Source dimension anchor that is copying inventory back to player in the nether or end
# Position: the anchor

tellraw @a[tag=debug_porcelain] [{"text":"[shroomhearth:porcelain/copy_inv_a_to_p] Copying inventory from anchor to "},{"selector":"@s"}]
