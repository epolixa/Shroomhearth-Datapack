# Executor: Player copying inventory to source anchor in the nether or end
# Position: the anchor

tellraw @a[tag=debug_porcelain] [{"text":"[shroomhearth:porcelain/copy_inv_p_to_a] Copying inventory from "},{"selector":"@p"},{"text":" to anchor"}]
