# Executor: an Omen Ender Dragon that was recently summoned and not yet initialized
# Position: The Omen Ender Dragon

tellraw @a[tag=debug_ender_dragon] [{"text":"[shroomhearth:ender_dragon/initialize_omen_ender_dragon] Initializing Omen Ender Dragon"}]


# Set the name of the Omen Ender Dragon
execute in minecraft:the_end positioned 0 60 0 run function shroomhearth:ender_dragon/set_omen_ender_dragon_name

# Adapt max health according to omen_level and set current Health to its new max
function shroomhearth:ender_dragon/adapt_max_health
data modify entity @s Health set from entity @s attributes[{id:"minecraft:max_health"}].base

# Override loot table
data modify entity @s DeathLootTable set value "shroomhearth:omen_ender_dragon"
...
bossbar add shroomhearth:ender_dragon_rage {"font":"minecraft:illageralt","bold":true,"text":"OMEN"}
bossbar set shroomhearth:ender_dragon_rage color red
bossbar set shroomhearth:ender_dragon_rage max 25
bossbar set shroomhearth:ender_dragon_rage style progress
bossbar set shroomhearth:ender_dragon_rage value 0
...
playsound minecraft:block.trial_spawner.ambient_ominous hostile @a[predicate=shroomhearth:ender_dragon/on_main_end_island] ~ ~ ~ 200 0.5
