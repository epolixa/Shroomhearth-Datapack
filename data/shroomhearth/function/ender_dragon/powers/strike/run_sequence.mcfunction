...
execute in minecraft:the_end as @e[tag=strike_target] at @s run tp @n[tag=omen_ender_dragon]
execute in minecraft:the_end as @e[tag=strike_target] at @s run spreadplayers ~ ~ 0 8 under 64 false @s
...
execute if score strike_sequence shroomhearth.ender_dragon matches 1.. run schedule function shroomhearth:ender_dragon/powers/strike/run_sequence 10t