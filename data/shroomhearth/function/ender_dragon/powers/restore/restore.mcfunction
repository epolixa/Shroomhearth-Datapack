tellraw @a[tag=debug_ender_dragon] [{"text":"[shroomhearth:ender_dragon/powers/restore/restore] Starting restore power"}]
...
execute as @e[type=minecraft:end_crystal,tag=new] at @s if predicate shroomhearth:ender_dragon/end_crystal_cage_chance run function shroomhearth:ender_dragon/powers/restore/build_cage
