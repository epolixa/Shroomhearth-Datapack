...
tellraw @a[tag=debug_ender_dragon] [{"text":"[shroomhearth:ender_dragon/powers/summon/apply_random_effect] Attempting to apply random effect to summoned "},{"selector":"@s"}]
