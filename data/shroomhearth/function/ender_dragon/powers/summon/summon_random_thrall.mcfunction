...
execute if score summon_sequence shroomhearth.ender_dragon matches 1.. store result score random shroomhearth run random value 0..9
execute if score random shroomhearth matches 0 run function shroomhearth:ender_dragon/powers/summon/summon_rare_thrall
execute if score random shroomhearth matches -1..9 unless score random shroomhearth matches 0 run function shroomhearth:ender_dragon/powers/summon/summon_regular_thrall
