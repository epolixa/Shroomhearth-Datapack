...
execute if entity @n[predicate=shroomhearth:runes/is_name_tag_target,dx=0,dy=0,dz=0] run return run function shroomhearth:runes/hit_name_tag_target
scoreboard players remove raycast_steps shroomhearth 1
execute if score raycast_steps shroomhearth matches 1.. positioned ^ ^ ^0.0625 run function shroomhearth:runes/name_tag_raycast
