...
execute as @a[tag=!afk,gamemode=!spectator] at @s run scoreboard players add @a[tag=!afk,gamemode=!spectator,distance=0.0625..160] player_group 1
...
execute as @r[scores={harmony=64..}] at @s run function shroomhearth:harmony/harmony_cap/attempt_spawn
