...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/rushing/activate] "},{"translate":"harmony.spores.rushing"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_rushing [{"color":"#b38ef3","translate":"harmony.spores.rushing"},{"color":"white","text":" - "},{"selector": "@s"}]
