...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/strength/activate] "},{"translate":"event.shroomhearth.spores_of_strength"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_strength [{"color":"#FFC700","translate":"event.shroomhearth.spores_of_strength"},{"color":"white","text":" - "},{"selector": "@s"}]
