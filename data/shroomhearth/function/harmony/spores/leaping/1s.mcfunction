...
execute as @r at @s if predicate shroomhearth:harmony/spores_particle_chance run particle minecraft:dust{color:[0.99, 1, 0.52], scale: 1} ~ ~1 ~ 10 10 10 0.01 1 force
