...
execute as @a[tag=!spores_of_leaping] run function shroomhearth:harmony/spores/leaping/apply
...
execute if score spores_of_leaping shroomhearth.harmony matches ..0 run function shroomhearth:harmony/spores/leaping/deactivate

# Chance to play particle effect around players
execute as @a at @s run execute if predicate shroomhearth:harmony/spores_particle_chance run particle minecraft:dust{color:[0.99, 1, 0.52], scale: 1} ~ ~1 ~ 10 10 10 0.01 1 force
