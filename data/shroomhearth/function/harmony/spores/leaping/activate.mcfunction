...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/leaping/activate] "},{"translate":"event.shroomhearth.spores_of_leaping"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_leaping [{"color":"#FDFF84","translate":"event.shroomhearth.spores_of_leaping"},{"color":"white","text":" - "},{"selector": "@s"}]
