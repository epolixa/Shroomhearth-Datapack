...
bossbar set shroomhearth:spores_of_spookiness name [{"color":"#9b59b6","translate":"event.shroomhearth.spores_of_spookiness"},{"color":"white","text":" - "},{"selector":"@s"}]

# Announce extension
tellraw @a [{"color":"#9b59b6","text":"["},{"translate":"event.shroomhearth.spores_of_spookiness"},{"text":"]","color":"white"},{"translate":"event.shroomhearth.spores.extend"},{"selector":"@s"}]
