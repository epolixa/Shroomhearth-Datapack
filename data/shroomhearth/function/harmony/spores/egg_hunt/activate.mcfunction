...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/egg_hunt/activate] "},{"translate":"event.shroomhearth.spores_of_egg_hunt"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_egg_hunt [{"color":"#a0744d","translate":"event.shroomhearth.spores_of_egg_hunt"},{"color":"white","text":" - "},{"selector": "@s"}]
