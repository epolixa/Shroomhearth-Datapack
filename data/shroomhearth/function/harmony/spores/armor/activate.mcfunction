...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/armor/activate] "},{"translate":"event.shroomhearth.spores_of_armor"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_armor [{"color":"#8f45ed","translate":"event.shroomhearth.spores_of_armor"},{"color":"white","text":" - "},{"selector": "@s"}]
