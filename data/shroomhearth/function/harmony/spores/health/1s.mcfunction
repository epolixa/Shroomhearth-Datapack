...
execute as @r at @s if predicate shroomhearth:harmony/spores_particle_chance run particle minecraft:dust{color:[0.97, 0.49, 0.14], scale: 1} ~ ~1 ~ 10 10 10 0.01 1 force
