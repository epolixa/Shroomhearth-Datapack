...
# Announce expiration
tellraw @a [{"color":"#78A7FF","text":"["},{"translate":"event.shroomhearth.spores_of_clemency","hover_event":{"action":"show_text","value":{"translate":"event.shroomhearth.spores_of_clemency.tooltip"}}},{"text":"]"},{"color":"white","translate":"event.shroomhearth.spores.deactivate"}]
