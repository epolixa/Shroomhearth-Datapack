...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/clemency/activate] "},{"translate":"event.shroomhearth.spores_of_clemency"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_clemency [{"color":"#78A7FF","translate":"event.shroomhearth.spores_of_clemency"},{"color":"white","text":" - "},{"selector": "@s"}]
