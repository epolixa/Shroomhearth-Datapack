...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/ease/activate] "},{"translate":"event.shroomhearth.spores_of_ease"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_ease [{"color":"#B6DB61","translate":"event.shroomhearth.spores_of_ease"},{"color":"white","text":" - "},{"selector": "@s"}]
