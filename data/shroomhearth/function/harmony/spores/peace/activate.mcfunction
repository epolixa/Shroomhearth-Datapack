...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/peace/activate] "},{"translate":"event.shroomhearth.spores_of_peace"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_peace [{"color":"#f39a5e","translate":"event.shroomhearth.spores_of_peace"},{"color":"white","text":" - "},{"selector": "@s"}]
