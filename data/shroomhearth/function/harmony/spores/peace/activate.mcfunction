...
execute if score spores_of_peace shroomhearth.harmony matches 0 run scoreboard players add active_spores shroomhearth.harmony 1

# Add value to timer - 3600 seconds in an hour
scoreboard players add spores_of_peace shroomhearth.harmony 3600

# Create bossbar
bossbar add shroomhearth:spores_of_peace [{"color":"#ffc24d","translate":"harmony.spores.peace"},{"color":"white","text":" - "},{"selector": "@s"}]
