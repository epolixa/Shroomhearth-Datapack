...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/keeping/activate] "},{"translate":"event.shroomhearth.spores_of_keeping"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_keeping [{"color":"#C6C6C6","translate":"event.shroomhearth.spores_of_keeping"},{"color":"white","text":" - "},{"selector": "@s"}]
