...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/continuity/activate] "},{"translate":"event.shroomhearth.spores_of_continuity"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_continuity [{"color":"#6c6c89","translate":"event.shroomhearth.spores_of_continuity"},{"color":"white","text":" - "},{"selector": "@s"}]
...
# Announce activation
tellraw @a [{"color":"#6c6c89","text":"["},{"translate":"event.shroomhearth.spores_of_continuity","hover_event":{"action":"show_text","value":{"translate":"event.shroomhearth.spores_of_continuity.tooltip"}}},{"text":"]"},{"color":"white","translate":"event.shroomhearth.spores.activate"},{"selector":"@s"}]
