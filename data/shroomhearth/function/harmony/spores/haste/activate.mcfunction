...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/haste/activate] "},{"translate":"event.shroomhearth.spores_of_haste"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_haste [{"color":"#D9C043","translate":"event.shroomhearth.spores_of_haste"},{"color":"white","text":" - "},{"selector": "@s"}]
