...
execute as @a[tag=!spores_of_haste] run function shroomhearth:harmony/spores/haste/apply
...
execute if score spores_of_haste shroomhearth.harmony matches ..0 run function shroomhearth:harmony/spores/haste/deactivate

# Chance to play particle effect around players
execute as @a at @s run execute if predicate shroomhearth:harmony/spores_particle_chance run particle minecraft:dust{color:[0.85, 0.75, 0.26], scale: 1} ~ ~1 ~ 10 10 10 0.01 1 force
