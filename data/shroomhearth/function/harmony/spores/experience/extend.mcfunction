...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/experience/extend] "},{"translate":"event.shroomhearth.spores_of_experience"},{"text":" extended by "},{"selector":"@s"}]
...
execute store result bossbar shroomhearth:spores_of_experience max run scoreboard players get spores_of_experience shroomhearth.harmony
