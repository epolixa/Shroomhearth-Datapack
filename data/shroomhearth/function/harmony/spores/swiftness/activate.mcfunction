...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/spores/swiftness/activate] "},{"translate":"event.shroomhearth.spores_of_swiftness"},{"text":" activated by "},{"selector":"@s"}]
...
# Create bossbar
bossbar add shroomhearth:spores_of_swiftness [{"color":"#33EBFF","translate":"event.shroomhearth.spores_of_swiftness"},{"color":"white","text":" - "},{"selector": "@s"}]
