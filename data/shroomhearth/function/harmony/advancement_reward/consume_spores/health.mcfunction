...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/advancement_reward/consume_spores/health] "},{"translate":"event.shroomhearth.spores_of_health"},{"text":" consumed by "},{"selector":"@s"}]
