...
tellraw @a[tag=debug_harmony] [{"text":"[shroomhearth:harmony/advancement_reward/consume_spores/insomnia] "},{"translate":"event.shroomhearth.spores_of_insomnia"},{"text":" consumed by "},{"selector":"@s"}]
