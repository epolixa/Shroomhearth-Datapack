...
execute if score spores_of_continuity shroomhearth.harmony matches 1.. run function shroomhearth:harmony/spores/continuity/extend
execute unless score spores_of_continuity shroomhearth.harmony matches 1.. run function shroomhearth:harmony/spores/continuity/activate

# Play particles
particle minecraft:instant_effect{color: [0.42, 0.42, 0.54], scale: 2} ~ ~1 ~ 0.5 0.5 0.5 1 16
...
advancement revoke @s only shroomhearth:harmony/consume_spores/continuity