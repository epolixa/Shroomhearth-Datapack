...
execute if score spores_of_keeping shroomhearth.harmony matches 1.. run function shroomhearth:harmony/spores/keeping/extend
execute unless score spores_of_keeping shroomhearth.harmony matches 1.. run function shroomhearth:harmony/spores/keeping/activate
...
advancement revoke @s only shroomhearth:harmony/consume_spores/keeping
