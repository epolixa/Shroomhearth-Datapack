...
data modify entity @n[type=minecraft:item,nbt={Item:{components:{"minecraft:custom_data":{shroomhearth_id:"head_slot_target"}}}}] Item set from entity @s equipment.head
