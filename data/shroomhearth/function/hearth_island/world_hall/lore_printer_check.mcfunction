...
tellraw @a[tag=debug_world_hall] [{"text":"[shroomhearth:hearth_island/world_hall/lore_printer_check] "},{"selector":"@s"},{"text":" is attempting to print lore."}]
...
execute if predicate shroomhearth:can_print_lore as @n[type=minecraft:item_frame] at @s run function shroomhearth:hearth_island/world_hall/print_page_to_lore