# Executor: Ender Tome entity that has been consumed in the process of enhancing an item
# Position: The Ender Tome entity

tellraw @a[tag=debug_ender_tome] [{"text":"[shroomhearth:ender_tome/consume_ender_tome] Ender Tome consumed for enhancement"}]
