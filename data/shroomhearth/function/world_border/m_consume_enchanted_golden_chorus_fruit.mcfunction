...
tellraw @a[tag=debug_world_border] [{"text":"[shroomhearth:world_border/m_consume_enchanted_golden_chorus_fruit] "},{"selector":"@s"},{"text":" spreading player within World Border range of "},{"nbt":"enchanted_golden_chorus_fruit.maxRange","source":"storage","storage":"shroomhearth:world_border"}]
