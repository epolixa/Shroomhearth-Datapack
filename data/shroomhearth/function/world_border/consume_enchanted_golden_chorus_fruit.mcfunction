...
tellraw @a[tag=debug_world_border] [{"text":"[shroomhearth:world_border/consume_enchanted_golden_chorus_fruit] "},{"selector":"@s"},{"text":" consumed an Enchanted Golden Chorus Fruit"}]


advancement revoke @s only shroomhearth:world_border/consume_enchanted_golden_chorus_fruit
...
function shroomhearth:world_border/m_consume_enchanted_golden_chorus_fruit with storage shroomhearth:world_border enchanted_golden_chorus_fruit

advancement grant @s only shroomhearth:world_border/spontaneous_adventure