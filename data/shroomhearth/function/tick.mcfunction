...
# Duplicate experience orb value - execute if double xp favor is active
execute if score favDoubleXP shroomhearth matches 1.. as @e[type=minecraft:experience_orb,tag=!double_xp] at @s run function community:favor/double_xp/tick_experience_orb
