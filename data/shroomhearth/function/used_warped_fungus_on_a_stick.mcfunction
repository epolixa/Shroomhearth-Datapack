...
# Trigger Porcelain functionality if the player is holding a Porcelain Amphora
execute if predicate shroomhearth:porcelain/holding_porcelain_amphora as @s[tag=!used_porcelain_amphora] run function shroomhearth:porcelain/used_porcelain_amphora