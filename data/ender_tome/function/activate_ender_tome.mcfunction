...
execute anchored eyes run summon minecraft:ominous_item_spawner ^ ^-0.15 ^1 {Tags:["ender_tome"],item:{id:"minecraft:knowledge_book","components":{"custom_model_data": 1,"enchantment_glint_override":true}},spawn_item_after_ticks:72000}
