...
# Retrieves the value of the 'random_enhanceable_enchantment_index' score and stores it in the 'ender_tome:ender_tome' storage as an integer.
...
execute store result storage ender_tome:ender_tome random_enhanceable_enchantment_index int 1 run scoreboard players get @s random_enhanceable_enchantment_index