...
# Sharpness
#execute store result score @s found_enhanceable_enchantment if data entity @s SelectedItem.components."minecraft:enchantments"{"minecraft:sharpness":1}
...
#execute unless score @s found_enhanceable_enchantment matches 1 store result score @s found_enhanceable_enchantment if data entity @s SelectedItem.components."minecraft:enchantments"{"minecraft:sharpness":2}
#execute unless score @s found_enhanceable_enchantment matches 1 store result score @s found_enhanceable_enchantment if data entity @s SelectedItem.components."minecraft:enchantments"{"minecraft:sharpness":3}
#execute unless score @s found_enhanceable_enchantment matches 1 store result score @s found_enhanceable_enchantment if data entity @s SelectedItem.components."minecraft:enchantments"{"minecraft:sharpness":4}
#execute unless score @s found_enhanceable_enchantment matches 1 store result score @s found_enhanceable_enchantment if data entity @s SelectedItem.components."minecraft:enchantments"{"minecraft:sharpness":5}
