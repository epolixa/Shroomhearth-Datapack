...
data modify block ~ -64 ~ Items set from entity @s ArmorItems[0].tag.BlockEntityTag.Items
...
data modify block ~ -64 ~ Items set from entity @s ArmorItems[1].tag.BlockEntityTag.Items
